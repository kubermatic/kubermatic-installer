...
```bash
./clcg create-ca --output-dir ./
```

## Generate Service account key
```bash
./clcg create-service-account-key --output-dir ./
```

## Generate Container Linux configs + ignition
```
./clcg create-cluster-configs --config config.yaml --template template.yaml --output-dir ./
```
